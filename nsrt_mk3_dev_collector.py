...
tags = [
    "# measurement_name = decibels", f"# model = {model}",
    f"# serial = {serial_number}", f"# firmware = {firmware_revision}",
    f"# date_manufacture = {date_of_birth}",
    f"# date_calibration = {date_of_calibration}", f"# weighting = {weighting}"
]
...
handler = MyTimedRotatingFileHandler(LOGDIR + '/' + LOGFILENAME,
                                     when='midnight',
                                     header=header)
